...
namespace HerosInsight::RichText
{
    ...
    struct Drawer
    {
        ...
        void DrawTextSegments(std::span<TextSegment> segments, float wrapping_min = -1, float wrapping_max = -1);
        void DrawRichText(std::string_view text, float wrapping_min = -1, float wrapping_max = -1, std::span<uint16_t> highlighting = {}, TextSegment::WrapMode first_segment_wrap_mode = TextSegment::WrapMode::Disallow);
    };
